export const navItems = [
  ...
  export const gridItems = [
    ...
    },
    {
      id: 2,
      title: "My Work",
      description: "My work focuses on data and automation in the built environment. I’ve worked on everything from large-scale engineering projects to furniture design, and more recently, I’ve been exploring web development with tools like Vue.js, Three.js, and Python. I’m passionate about learning, sharing knowledge, and finding ways to make workflows smarter and more efficient.",
